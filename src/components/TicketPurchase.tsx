    ...
    <div className="py-8 md:py-12 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-base md:text-lg text-gray-600">Select your numbers and purchase your tickets</p>
        </div>
          ...
          <CardContent className="p-4 md:p-6">
            ...
            <div className="mb-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-3">
                <Label className="text-base md:text-lg font-semibold">Select Your Numbers</Label>
              ...
              <div className="text-center">
                ...
                {userNumbers.length === currentGame.maxNumbers && (
                  <div className="bg-green-100 border border-green-300 rounded-lg p-3 mb-4 animate-slide-up">
                    <p className="text-green-800 font-semibold text-sm md:text-base">✓ Numbers selected! Ready to purchase.</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="border-t pt-6">
              ...
              <Button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 md:py-4 text-base md:text-lg animate-fade-in"
              >
                Purchase Tickets
              </Button>
            </div>
