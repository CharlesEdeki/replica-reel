...
export const games: Game[] = [
  {
    id: 'lotto',
    name: 'Lotto',
    tagline: 'Naija\'s favourite lottery game',
  ...
  },
  {
    id: 'afromillions',
    name: 'AfroMillions',
    tagline: 'Naija\'s biggest lottery',
    description: 'AfroMillions offers some of the biggest jackpots in the world. Pick 5 main numbers and 2 Lucky Stars for your chance to win up to ₦220 million.',
    howToPlay: [
    ...
    features: ['Nigerian jackpots', 'Lucky Stars', 'Millionaire Maker', 'HotPicks'],
